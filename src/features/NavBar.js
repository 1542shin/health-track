...
export const NavBar = () => {
  return (
    ...
    >
      <Toolbar>
        <img src={gymIcon} alt='gymIcon' width={25} height={25} style={{ marginRight: 10 }} />
        <Typography variant="h6" noWrap component="div">
          Health Track
        </Typography>
        <Box style={{flexGrow:10}}> </Box>
          <Box  sx={{ display: "flex", alignItems: "center" }}>
            <a id="github" href='https://github.com/1542shin/health-track' target="_blank"  rel="noreferrer">
              <img
